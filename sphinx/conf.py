...
# -*- coding: utf-8 -*-
#
# luna_lang documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'luna_lang'
copyright = 'ProgramingIsTheFuture <franciscosantosfcp@hotmail.com>'
author = 'ProgramingIsTheFuture <franciscosantosfcp@hotmail.com>'
...
latex_documents = [
    (master_doc, 'luna_lang.tex', 'luna_lang Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'luna_lang', 'luna_lang Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'luna_lang', 'luna_lang Documentation',
     author, 'luna_lang', 'One line description of project.',
     'Miscellaneous'),
]
